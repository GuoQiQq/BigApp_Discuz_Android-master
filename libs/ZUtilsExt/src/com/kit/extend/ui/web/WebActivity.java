...
//        setCookieFromCookieStore(this, content);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        Log.e("webFragment", "webFragment" + webFragment.getWebView().canGoBack());
        if ((keyCode == KeyEvent.KEYCODE_BACK)) {
            if (webFragment.getWebView().canGoBack() && !webFragment.getWebTitle().equals(null)) {
                if (webFragment.getWebTitle().equals("家医签约百城巡讲活动") || webFragment.getWebTitle().equals("修改资料") || webFragment.getWebTitle().equals("QQ登录")) {
                    this.finish();
                    return true;
                } else {
                    // 返回键退回
