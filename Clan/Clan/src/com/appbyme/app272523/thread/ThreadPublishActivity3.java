package com.appbyme.app272523.thread;
...
import com.appbyme.app272523.base.net.DoThread;
...
import com.appbyme.app272523.common.images.PicSelectorActivity3;
...
public class ThreadPublishActivity3 extends ThreadReplyActivity implements View.OnClickListener {
    ...
    private void loadThreadType() {
        ThreadHttp.threadType(this, fid, new StringCallback(this) {
            ...
            public void onFailed(Context cxt, int errorCode, String msg) {
                super.onFailed(ThreadPublishActivity3.this, errorCode, msg);
                spinner.setVisibility(View.GONE);
            }
        });
    }
    ...
    private void initThreadTypeWidget() {
        ...
        spinner.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                ZogUtils.printError(ThreadPublishActivity3.class, "position：" + position + " fid：" + fid);
            }
        });
...
//            return false;
//        }
        String tags = et2.getText().toString().trim();
        tags = DefEmoticons.replaceUnicodeByShortname(this, tags);
        Log.e("tags","tags===" + tags);
        ...
        DoCheckPost.getCheckPost(this, fid, new InjectDo<BaseJson>() {
            ...
            public boolean doSuccess(BaseJson baseJson) {
                ...
                if (allowperm.getAllowPost().equals("1")) {
                    //发新帖
                    ThreadPublishActivity3.super.send();
    ...
    public void doSend() {
        ...
        DoThread.newThread(ThreadPublishActivity3.this, handler, fid, typeId, title, content, attachSet,tags);
    }
}
