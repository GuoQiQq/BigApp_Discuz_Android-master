...
//        setContentView(R.layout.activity_thread_detail);
    ...
    public boolean initWidget() {
        ...
        if (threadTypes != null && threadTypes.getTypes() != null) {
            ...
            Log.e("threadTypes======","threadTypes=======" + threadTypes.getTypes());
...
//        content = DefEmoticons.replaceUnicodeByShortname(this, etStr).toString();
        ...
        //标签
        String et2Tags = et2.getText().toString();
        tags = DefEmoticons.replaceUnicodeByShortname(this,et2Tags);
        if (tags.equals("")){
            tags = null;
            return true;
        }
    ...
    public void doSend() {
        ...
        DoThread.newThread(ThreadNewActivity.this, handler, fid, typeId, title, content, attachSet,tags);
