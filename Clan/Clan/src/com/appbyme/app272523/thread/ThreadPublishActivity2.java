...
public class ThreadPublishActivity2 extends ThreadReplyActivity implements View.OnClickListener {
    ...
    private void loadThreadType() {
        ThreadHttp.threadType(this, fid, new StringCallback(this) {
            ...
            public void onFailed(Context cxt, int errorCode, String msg) {
                super.onFailed(ThreadPublishActivity2.this, errorCode, msg);
                spinner.setVisibility(View.GONE);
            }
        });
    }
    ...
    private void initThreadTypeWidget() {
        ...
        spinner.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                ZogUtils.printError(ThreadPublishActivity2.class, "position：" + position + " fid：" + fid);
            }
        });
...
//        }
        ...
        DoCheckPost.getCheckPost(this, fid, new InjectDo<BaseJson>() {
            ...
            public boolean doSuccess(BaseJson baseJson) {
                ...
                if (allowperm.getAllowPost().equals("1")) {
                    //发新帖
                    ThreadPublishActivity2.super.send();
    ...
    public void doSend() {
        ...
        DoThread.newThread(ThreadPublishActivity2.this, handler, fid, typeId, title, content, attachSet,tags);
    }
}
