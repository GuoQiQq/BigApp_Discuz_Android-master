...
public class ThreadPublishActivity1 extends ThreadReplyActivity implements View.OnClickListener {
    ...
    private void loadThreadType() {
        ThreadHttp.threadType(this, fid, new StringCallback(this) {
            ...
            public void onFailed(Context cxt, int errorCode, String msg) {
                super.onFailed(ThreadPublishActivity1.this, errorCode, msg);
                spinner.setVisibility(View.GONE);
            }
        });
    }
       ...
       spinner.setHint(getString(R.string.no_select));
        spinner.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                ZogUtils.printError(ThreadPublishActivity1.class, "position：" + position + " fid：" + fid);
            }
        });
...
//        }
        ...
        DoCheckPost.getCheckPost(this, fid, new InjectDo<BaseJson>() {
            ...
            public boolean doSuccess(BaseJson baseJson) {
                ...
                if (allowperm.getAllowPost().equals("1")) {
                    //发新帖
                    ThreadPublishActivity1.super.send();
    ...
    public void doSend() {
        ...
        DoThread.newThread(ThreadPublishActivity1.this, handler, fid, typeId, title, content, attachSet,tags);
    }
}
