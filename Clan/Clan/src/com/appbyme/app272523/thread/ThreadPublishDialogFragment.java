...
public class ThreadPublishDialogFragment extends DialogFragment {
    ...
    private void confirm(View view) {
        ...
        }else if(context instanceof ThreadPublishActivity1){
            dismiss();
            ((ThreadPublishActivity1)context).onConfirm(forum.getCurrentItem(), thread.getCurrentItem(), subThread.getCurrentItem());
        }else if(context instanceof ThreadPublishActivity2){
            dismiss();
            ((ThreadPublishActivity2)context).onConfirm(forum.getCurrentItem(), thread.getCurrentItem(), subThread.getCurrentItem());
        }else if(context instanceof ThreadPublishActivity3){
            dismiss();
            ((ThreadPublishActivity3)context).onConfirm(forum.getCurrentItem(), thread.getCurrentItem(), subThread.getCurrentItem());
        }
    }
