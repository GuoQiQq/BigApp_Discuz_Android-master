...
import com.appbyme.app272523.base.widget.SuperViewPager;
import com.appbyme.app272523.login.LoginActivity;
import com.appbyme.app272523.main.wechatstyle.WeChatStyleFragmentAdapter;
            ...
            if (BottomButtonType.THREAD_PUBLISH.equals(s.getButtonType())) {
                ...
                tabItem = new TabItem(s.getButtonName(), normal, press, textNormalColor, textSelectedColor, true, StringUtils.isEmptyOrNullOrNullStr(s.getButtonName()), 10, new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        DiaFragment editNameDialog = new DiaFragment();
                        editNameDialog.show(getFragmentManager(), "EditNameDialog");

//                        JumpWebUtils.gotoWeb(getActivity(), "", "http://app.sqys.com/portal.php?mod=index&mobile=2");
...
//                }else {
                    ...
                    if (BottomButtonType.MESSAGE.equals(buttonConfig.getButtonType())&&!AppSPUtils.isLogined(getActivity()) ) {
                        IntentUtils.gotoNextActivity(getActivity(),LoginActivity.class);
