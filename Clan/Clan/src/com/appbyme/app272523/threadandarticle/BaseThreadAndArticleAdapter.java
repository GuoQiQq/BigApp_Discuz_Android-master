...
import com.appbyme.app272523.base.util.view.threadandarticle.ContentUtils;
...
import com.appbyme.app272523.base.widget.list.IRefreshAndEditableAdapter;
import com.appbyme.app272523.base.widget.list.OnDataSetChangedObserver;
import com.appbyme.app272523.base.widget.list.OnLoadListener;
import com.appbyme.app272523.forum.ForumClickListener;
...
//        parseEmoji(threads);
    ...
    public ArrayList<NavForum> getSubList(ForumDisplayJson json) {
        ...
        if (variables != null && variables.getSubList() != null && variables.getSubList().size() > 0) {
            subList.clear();
            for (com.youzu.clan.base.json.forumdisplay.Forum forum : variables.getSubList()) {
