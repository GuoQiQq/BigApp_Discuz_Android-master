...
import com.appbyme.app272523.login.BindActivity;
import com.appbyme.app272523.login.LoginActivity;
import com.appbyme.app272523.login.LoginPlatformActionListener;
...
public class DoLogin {
    ...
    public static void authorize(final FragmentActivity context, String platStr, Handler.Callback callback, InjectDo injectDo) {
        ...
        if (plat.isValid()) {
            ...
            Log.e("callBack", "回调信息 " + callback + " context " + context);
