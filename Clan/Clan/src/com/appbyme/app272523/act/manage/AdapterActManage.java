package com.appbyme.app272523.act.manage;
...
public class AdapterActManage extends BaseRefreshAdapter<ActPlayerJson> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final CheckBox cb_item = com.appbyme.app272523.base.widget.ViewHolder.get(convertView, R.id.cb_item);
        TextView tv_name = com.appbyme.app272523.base.widget.ViewHolder.get(convertView, R.id.tv_name);
        TextView tv_time = com.appbyme.app272523.base.widget.ViewHolder.get(convertView, R.id.tv_time);
        TextView tv_status = com.appbyme.app272523.base.widget.ViewHolder.get(convertView, R.id.tv_status);
        TextView tv_desc = com.appbyme.app272523.base.widget.ViewHolder.get(convertView, R.id.tv_desc);
        TextView tv_more = com.appbyme.app272523.base.widget.ViewHolder.get(convertView, R.id.tv_more);
        View v_margin_bottom = com.appbyme.app272523.base.widget.ViewHolder.get(convertView, R.id.v_margin_bottom);
