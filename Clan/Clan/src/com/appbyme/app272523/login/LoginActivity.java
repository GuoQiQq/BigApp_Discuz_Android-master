...
import com.appbyme.app272523.app.InjectDo;
...
import com.appbyme.app272523.base.net.DoLogin;
import com.appbyme.app272523.base.net.DoProfile;
...
//    @ViewInject(R.id.retrievepassword)
//    private WithDelEditText retrievePassword;
    ...
    public void retrieve(View view){
        WebActivity.gotoWeb(this,WebActivity.class,"","http://app.sqys.com/source/plugin/login_mobile/fe/findpass.html");
    }
//    @OnClick(R.id.register)
//    public void register(View view){
//        WebActivity.gotoWeb(this,WebActivity.class,"","http://app.sqys.com/source/plugin/login_mobile/fe/regist.html");
//    }
...
//    public void webLogin1(View view) {
////        WebActivity.gotoWeb(this,WebActivity.class,"","http://app.sqys.com/source/plugin.php?id=mteldis:register&login=1");
////        ClanUtils.gotoLogin(this, null, ResultCode.REQUEST_CODE_WEB_LOGIN, false);
//        BundleData bundleData = new BundleData();
//        LoginInfo loginInfo = AppSPUtils.getLoginInfo(this);
//
//        if (loginInfo == null) {
//            return;
//        }
...
//            //native
//            IntentUtils.gotoSingleNextActivity(this, WebLoginActivity.class, bundleData, false, ResultCode.REQUEST_CODE_WEB_LOGIN);
//        } else {
////            //web
//
//            if (bundleData == null) {
//                String url = "http://app.sqys.com/plugin.php?id=mteldis:register&login=1";
////                String url = "http://192.168.180.23:8080/discuz/member.php?mod=logging&action=login&mobile=2";
//
//                String cookie = CookieUtils.getCookie(this, url);
//
//                bundleData = new BundleData();
//                bundleData.put("title", this.getResources().getString(R.string.login));
//                bundleData.put("content", url);
//                bundleData.put("cookie", cookie);
//            }
//            IntentUtils.gotoNextActivity(this, WebLoginActivity.class, bundleData, ResultCode.REQUEST_CODE_WEB_LOGIN);
//        }
//    }
